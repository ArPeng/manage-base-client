<template>
  <div class="content" style="background:#f0f2f5;">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">请检查您输入的网址是否正确，请点击以下按钮回到控制台或返回上一页</div>
        <span
          v-waves
          @click="back"
          class="bullshit__return-home">返回上一页</span>
        <span
          v-waves
          @click="$router.push('/dashboard')"
          class="bullshit__return-home">返回控制台</span>
      </div>
    </div>
  </div>
</template>
